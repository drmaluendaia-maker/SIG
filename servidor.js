...
io.on('connection', (socket) => {
    ...
    socket.on('reevaluate_patient', async (payload) => {
        ...
        try {
            ...
            const updatedVitals = {
                tas: newVitals.tas || currentVitals.tas, tad: newVitals.tad || currentVitals.tad,
                fc: newVitals.fc || currentVitals.fc, so2: newVitals.so2 || currentVitals.so2,
                temp: newVitals.temp || currentVitals.temp, hgt: newVitals.hgt || currentVitals.hgt,
